import{j as t,a as e,u as z,A as N}from"./AbacusReact-7d06de32.js";import{r as c}from"./index-76fb7be0.js";import"./index-d3ea75b5.js";import"./_commonjsHelpers-de833af9.js";const m=[{id:"basic-5",title:"Basic Number 5",subtitle:"Simple representation of 5",value:5,config:{columns:1,beadShape:"diamond",colorScheme:"monochrome",scaleFactor:1,animated:!0,gestures:!0}},{id:"colorful-123",title:"Colorful 123",subtitle:"Multi-column with place value colors",value:123,config:{columns:3,beadShape:"diamond",colorScheme:"place-value",colorPalette:"default",scaleFactor:1,animated:!0,gestures:!0}},{id:"circles-42",title:"Circle Beads - 42",subtitle:"Different bead shape demonstration",value:42,config:{columns:2,beadShape:"circle",colorScheme:"place-value",colorPalette:"default",scaleFactor:1.2,animated:!0,gestures:!0}},{id:"large-7",title:"Large Scale - 7",subtitle:"Larger scale for better visibility",value:7,config:{columns:1,beadShape:"diamond",colorScheme:"place-value",colorPalette:"default",scaleFactor:2,animated:!0,gestures:!0}},{id:"compact-999",title:"Compact 999",subtitle:"Square beads with alternating colors",value:999,config:{columns:3,beadShape:"square",colorScheme:"alternating",scaleFactor:.8,animated:!0,gestures:!0}},{id:"educational-1234",title:"Educational 1234",subtitle:"Four-digit educational example",value:1234,config:{columns:4,beadShape:"circle",colorScheme:"place-value",colorPalette:"mnemonic",scaleFactor:.9,animated:!0,gestures:!0}},{id:"crop-single-1",title:"Single Digit",subtitle:"Minimal single column design",value:1,config:{columns:1,beadShape:"diamond",colorScheme:"monochrome",scaleFactor:.8,animated:!0,gestures:!0}},{id:"crop-quad-9999",title:"Four 9s",subtitle:"Maximum value demonstration",value:9999,config:{columns:4,beadShape:"diamond",colorScheme:"place-value",colorPalette:"colorblind",scaleFactor:.9,animated:!0,gestures:!0}},{id:"crop-large-scale-0",title:"Large Zero",subtitle:"Empty abacus representation",value:0,config:{columns:1,beadShape:"circle",colorScheme:"monochrome",scaleFactor:2,hideInactiveBeads:!1,animated:!0,gestures:!0}},{id:"crop-hidden-inactive-555",title:"Hidden Inactive",subtitle:"Clean look with hidden inactive beads",value:555,config:{columns:3,beadShape:"diamond",colorScheme:"place-value",colorPalette:"nature",hideInactiveBeads:!0,scaleFactor:1.4,animated:!0,gestures:!0}},{id:"crop-mixed-geometry-321",title:"Mixed Geometry",subtitle:"Demonstrating various configurations",value:321,config:{columns:3,beadShape:"circle",colorScheme:"place-value",colorPalette:"colorblind",scaleFactor:1.1,animated:!0,gestures:!0}},{id:"debug-89",title:"Debug: 89",subtitle:"Two-digit debugging example",value:89,config:{columns:2,beadShape:"diamond",colorScheme:"place-value",colorPalette:"default",scaleFactor:1,animated:!0,gestures:!0}},{id:"debug-456",title:"Debug: 456",subtitle:"Three-digit debugging example",value:456,config:{columns:3,beadShape:"circle",colorScheme:"place-value",colorPalette:"default",scaleFactor:.8,animated:!0,gestures:!0}}],G=({example:a,onValueChange:o,onBeadClick:i})=>{const[r,n]=c.useState(a.value),[s,p]=c.useState(0),g=z(a.config.columns==="auto"?Math.max(1,r.toString().length):a.config.columns,a.config.scaleFactor||1),l=c.useCallback(u=>{n(u),o==null||o(u)},[o]),d=c.useCallback(u=>{p(D=>D+1),i==null||i(u)},[i]),A=c.useCallback(()=>{n(a.value),p(0)},[a.value]);return t("div",{className:"gallery-card",children:[t("div",{className:"card-header",children:[t("div",{className:"card-title",children:[e("h3",{children:a.title}),e("p",{children:a.subtitle})]}),t("div",{className:"card-controls",children:[t("div",{className:"value-display",children:["Value: ",e("strong",{children:r})]}),t("div",{className:"interaction-stats",children:["Clicks: ",e("strong",{children:s})]}),e("button",{className:"reset-btn",onClick:A,title:"Reset to original value",children:"↻"})]})]}),e("div",{className:"card-content",children:e("div",{className:"abacus-container",style:{width:`${g.width}px`,height:`${g.height}px`,margin:"0 auto"},children:e(N,{value:r,...a.config,onClick:d,onValueChange:l})})}),e("div",{className:"card-footer",children:t("div",{className:"config-info",children:[e("span",{className:"config-tag",children:a.config.beadShape}),e("span",{className:"config-tag",children:a.config.colorScheme}),t("span",{className:"config-tag",children:["×",a.config.scaleFactor]})]})})]})},L=()=>{const[a,o]=c.useState("basic"),[i,r]=c.useState({totalClicks:0,totalValueChanges:0,activeExample:null}),n={basic:m.filter(l=>["basic-5","colorful-123","circles-42","large-7"].includes(l.id)),advanced:m.filter(l=>["compact-999","educational-1234","crop-hidden-inactive-555","crop-mixed-geometry-321"].includes(l.id)),debug:m.filter(l=>["crop-single-1","crop-quad-9999","crop-large-scale-0","debug-89","debug-456"].includes(l.id))},s=c.useCallback(l=>{r(d=>({...d,totalValueChanges:d.totalValueChanges+1}))},[]),p=c.useCallback(l=>{r(d=>({...d,totalClicks:d.totalClicks+1}))},[]),g=n[a];return t("div",{className:"interactive-gallery",children:[e("style",{children:`
        .interactive-gallery {
      ...
      `}),t("div",{className:"container",children:[t("div",{className:"header",children:[e("h1",{children:"🧮 Interactive Soroban Gallery"}),e("p",{children:"Click or drag the beads in natural directions to explore how a Japanese abacus works!"}),t("div",{className:"global-stats",children:[t("div",{className:"stat-item",children:[e("span",{children:"Total Interactions:"}),e("strong",{children:i.totalClicks})]}),t("div",{className:"stat-item",children:[e("span",{children:"Value Changes:"}),e("strong",{children:i.totalValueChanges})]})]})]}),e("div",{className:"stats",children:t("div",{className:"stats-info",children:[e("strong",{children:m.length})," interactive examples • All abaci are fully interactive with click and directional gesture support • Generated with React + TypeScript"]})}),t("div",{className:"tutorial-box",children:[e("h3",{children:"🎯 How to Interact"}),t("p",{children:[e("strong",{children:"Click"})," beads to toggle their positions • ",e("strong",{children:"Drag"})," beads toward/away from the center bar •",e("strong",{children:"Reset"})," button restores original values • Each interaction updates the value in real-time"]})]}),t("div",{className:"tabs",children:[t("div",{className:"tab-nav",children:[e("button",{className:`tab-button ${a==="basic"?"active":""}`,onClick:()=>o("basic"),children:"📚 Basic Examples"}),e("button",{className:`tab-button ${a==="advanced"?"active":""}`,onClick:()=>o("advanced"),children:"🎨 Advanced Features"}),e("button",{className:`tab-button ${a==="debug"?"active":""}`,onClick:()=>o("debug"),children:"🔧 Debug & Edge Cases"})]}),e("div",{className:"gallery-grid",children:g.map(l=>e(G,{example:l,onValueChange:s,onBeadClick:p},l.id))})]})]})]})},P={title:"Soroban/Interactive Gallery",component:L,parameters:{layout:"fullscreen",docs:{description:{component:`
