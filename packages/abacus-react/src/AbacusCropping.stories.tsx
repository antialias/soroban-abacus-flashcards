  ...
  render: () => (
    <div style={{ display: "flex", gap: "40px", alignItems: "flex-start" }}>
      ...
      <div style={{ textAlign: "center" }}>
        ...
        <p style={{ marginTop: "10px", color: "#3b82f6", fontWeight: "bold" }}>
          With Cropping
        </p>
        <p style={{ fontSize: "12px", color: "#94a3b8" }}>
          Focused on active beads
        </p>
      </div>
    </div>
  ),
      ...
      <div style={{ textAlign: "center" }}>
        ...
        >
          <AbacusStatic
            ...
            hideInactiveBeads
            cropToActiveBeads={{
              padding: { top: 15, bottom: 2, left: 5, right: 5 },
            }}
          />
        </div>
...
export const WithColorSchemes: Story = {
  render: () => (
    <div style={{ display: "flex", gap: "30px", flexWrap: "wrap" }}>
      {(
        ["place-value", "monochrome", "heaven-earth", "alternating"] as const
      ).map((scheme) => (
  ...
  render: () => (
    <div>
      <p style={{ marginBottom: "20px", color: "#64748b", maxWidth: "600px" }}>
        These examples show how cropping is used for the dynamic favicon (see{" "}
        <code>/icon</code> route). Each day of the month gets its own cropped
        abacus icon.
      </p>
      <div
        style={{
...
export const AbacusReactCropping: Story = {
  render: () => (
    <div>
      <p style={{ marginBottom: "20px", color: "#64748b", maxWidth: "600px" }}>
        Cropping also works with <code>AbacusReact</code> (the interactive
        animated version). This is useful for interactive tutorials where you
        want to focus on specific beads.
      </p>
      <div style={{ display: "flex", gap: "40px", flexWrap: "wrap" }}>
        <div style={{ textAlign: "center" }}>
          <div
...
export const ComparisonGrid: Story = {
  render: () => {
    ...
    return (
      <div>
        <p
          style={{ marginBottom: "20px", color: "#64748b", maxWidth: "700px" }}
        >
          Comparison showing how cropping adapts to different bead
          configurations. Notice how the viewBox changes dynamically based on
          active beads.
        </p>
        <div
          style={{
