...
const meta: Meta<typeof StandaloneBead> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "A standalone bead component that can be used outside of the full abacus for icons, decorations, or UI elements. Respects AbacusDisplayContext for consistent styling.",
      },
    },
  },
  tags: ["autodocs"],
...
export const WithContextProvider: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Beads inherit shape from AbacusDisplayProvider context. Here they are all circles because the provider sets beadShape to "circle".',
      },
    },
  },
};
