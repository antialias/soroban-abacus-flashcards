...
- **[Accessibility](/story/soroban-abacusreact-core-examples--accessibility-palettes)** - Colorblind-friendly palettes
  ...
  argTypes: {
    ...
    interactive: {
      control: { type: "boolean" },
      description:
        "Enable user interactions (gestures and clicks) - when true, users can modify the abacus",
    },
    gestures: {
      control: { type: "boolean" },
      description:
        "Enable directional gesture interactions (legacy prop, use interactive instead)",
    },
    hideInactiveBeads: {
      control: { type: "boolean" },
...
export const InteractiveAbacus: Story = {
  render: () => {
    ...
    return (
      <div style={{ textAlign: "center", maxWidth: "600px", margin: "0 auto" }}>
        <h3
          style={{ margin: "0 0 20px 0", fontSize: "18px", color: "#2c3e50" }}
        >
          🎯 Interactive Abacus
        </h3>
        <div
        ...
        >
          ...
          >
            <div>
              <strong>Bead Clicks: {beadClicks}</strong>
            </div>
            <div>
              <strong>Value Changes: {valueChanges}</strong>
            </div>
          </div>
          <div style={{ fontSize: "12px", color: "#666", lineHeight: "1.4" }}>
            <strong>How to interact:</strong>
            <br />• <strong>Drag beads</strong> up/down with gestures
            <br />• <strong>Click beads</strong> to toggle them
            <br />• <strong>Click numbers</strong> below columns to edit
            directly
            <br />• <strong>Use keyboard</strong> (0-9, arrows, Tab, Escape)
            when editing numbers
          </div>
        </div>
        <div
          style={{
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Fully interactive abacus for teaching and practice. Users can drag beads, click to toggle, and edit numbers directly.",
      },
    },
  },
};
...
export const DisplayAbacus: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Static display abacus for showing values without user interaction.",
      },
    },
  },
};
...
export const CompactDisplay: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Compact display without numbers or inactive beads - ideal for embedding in content.",
      },
    },
  },
};
...
export const ColorSchemes: Story = {
    ...
    >
      <div style={{ textAlign: "center" }}>
        ...
        <p style={{ fontSize: "12px", color: "#666", margin: "0 0 15px 0" }}>
          Traditional black/white scheme
        </p>
        <AbacusReact
          value={678}
          columns={3}
      ...
      <div style={{ textAlign: "center" }}>
        ...
        <p style={{ fontSize: "12px", color: "#666", margin: "0 0 15px 0" }}>
          Blue/green alternating columns
        </p>
        <AbacusReact
          value={555}
          columns={3}
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Comparison of all available color schemes for different visual preferences and learning styles.",
      },
    },
  },
};
...
export const BeadShapes: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Comparison of available bead shapes: diamond (traditional), circle (modern), and square (geometric).",
      },
    },
  },
};
...
export const AccessibilityPalettes: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Specialized color palettes for accessibility, printing, and memory aids.",
      },
    },
  },
};
...
export const ScaleFactors: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Different scale factors for various use cases: compact layouts, standard display, and enhanced visibility.",
      },
    },
  },
};
...
export const HiddenBeadsBehavior: Story = {
  render: () => (
    <div style={{ display: "flex", gap: "40px", alignItems: "flex-start" }}>
      <div style={{ textAlign: "center" }}>
        ...
        >
          Hover to reveal inactive beads
          <br />
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Demonstrates different behaviors for inactive beads: hidden with hover reveal, always hidden, and always visible.",
      },
    },
  },
};
  ...
  render: () => {
    ...
    const tutorialSteps = [
      {
        ...
        highlightBeads: [
          { columnIndex: 4, beadType: "earth" as const, position: 0 },
        ],
    ...
    const handleBeadClick = (event: any) => {
      ...
      if (isCorrectTarget && step < tutorialSteps.length - 1) {
        ...
        if (step === 0) {
          message =
            "⚠️ Click the highlighted orange bead in the hundreds column (leftmost).";
        } else if (step === 1) {
    ...
    const customStyles = {
      ...
      beads: currentStepData.highlightBeads?.reduce(
        (acc, bead) => ({
          ...acc,
          [bead.columnIndex]: {
            [bead.beadType]:
              bead.beadType === "earth" && bead.position !== undefined
                ? {
                    [bead.position]: {
                      fill: "#ff6b35",
                      stroke: "#d63031",
    ...
    return (
      <div style={{ textAlign: "center", maxWidth: "600px", margin: "0 auto" }}>
        ...
        <Tooltip.Provider>
          ...
          >
            <AbacusReact
              ...
              overlays={
                showTooltip && currentStepData.overlays
                  ? currentStepData.overlays
                  : []
              }
            />
            ...
            {feedbackMessage && (
              <div
                style={{
                  ...
                  background: feedbackMessage.startsWith("✅")
                    ? "#d4edda"
                    : "#f8d7da",
        ...
        <div style={{ marginTop: "20px" }}>
          ...
          <button
            onClick={() =>
              setStep(Math.min(step + 1, tutorialSteps.length - 1))
            }
            style={{
              padding: "8px 16px",
              background: "#007bff",
        ...
        <div style={{ marginTop: "20px", fontSize: "12px", color: "#6c757d" }}>
          ...
          >
            <div>
              ...
              <br />
              • Column highlighting
              <br />• Individual bead targeting
            </div>
            <div>
              • Tooltip overlays
              <br />
              • Granular click callbacks
              <br />
              • Bead element refs for precise positioning
              <br />• Tutorial state management
            </div>
          </div>
        </div>
      </div>
...
export const DeveloperReference: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "All controls available for testing. Use the useAbacusDimensions hook for layout planning.",
      },
    },
