...
export const subtitles: Subtitle[] = [
  ...
  {
    text: 'Track Stack Pack',
    description: 'organize solutions systematically',
  },
  ...
  {
    text: 'Drive Thrive Arrive',
    description: 'push hard, succeed, reach goals',
  },
  ...
  {
    text: 'Blaze Graze Amaze',
    description: 'burn through, touch lightly, wow',
  },
  ...
  {
    text: 'Rank Bank Thank',
    description: 'earn status, save wins, appreciate',
  },
  {
    text: 'Merge Surge Verge',
    description: 'combine forces, power up, edge closer',
  },
  {
    text: 'Bold Gold Hold',
    description: 'brave attempts, prize rewards, maintain',
  },
