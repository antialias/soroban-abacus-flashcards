...
describe("SimulatedStudent Hill Function", () => {
  ...
  describe("different student profiles", () => {
    it("fast learner should reach 50% faster than slow learner", () => {
      ...
      const fastStudent = new SimulatedStudent(
        fastProfile,
        new SeededRandom(111),
      );
      const slowStudent = new SimulatedStudent(
        slowProfile,
        new SeededRandom(222),
      );
    ...
    it("pre-seeded profile should start with higher probability", () => {
      ...
      const blankStudent = new SimulatedStudent(
        blankProfile,
        new SeededRandom(111),
      );
      const preseededStudent = new SimulatedStudent(
        preseededProfile,
        new SeededRandom(222),
      );
      ...
      expect(preseededStudent.getTrueProbability("skill.test")).toBeCloseTo(
        0.69,
        1,
      );
    });
