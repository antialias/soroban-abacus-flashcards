        ...
        <div className={css({ display: "flex", gap: "0.5rem" })}>
          <button
            ...
            className={css({
              ...
              background:
                canCheckSolution && !isSpectating ? "teal.600" : "gray.300",
              color: "white",
              fontSize: "sm",
              fontWeight: "600",
              border: "none",
              cursor:
                canCheckSolution && !isSpectating ? "pointer" : "not-allowed",
              opacity: canCheckSolution && !isSpectating ? 1 : 0.5,
              _hover: {
                background:
                  canCheckSolution && !isSpectating ? "teal.700" : "gray.300",
              },
            })}
          >
            Check Solution
            ...
            {state.availableCards.map((card) => (
              <div
                ...
                className={css({
                  ...
                  border: "2px solid",
                  borderColor:
                    selectedCardId === card.id ? "#1976d2" : "transparent",
                  borderRadius: "8px",
          ...
          >
            ...
            <button
              ...
              className={css({
                ...
                height: "50px",
                background:
                  selectedCardId && !isSpectating ? "#1976d2" : "#2c5f76",
                color: "white",
                border: "none",
                borderRadius: "20px",
                fontSize: "24px",
                fontWeight: "bold",
                cursor:
                  selectedCardId && !isSpectating ? "pointer" : "not-allowed",
