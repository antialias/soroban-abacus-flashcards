        ...
        <div style={{ margin: "12px 0" }}>
          ...
          >
            <button
              ...
              style={{
                background:
                  state.playMode === "cooperative" ? "#10b981" : "white",
                color: state.playMode === "cooperative" ? "white" : "#1f2937",
                border: "2px solid",
                borderColor:
                  state.playMode === "cooperative" ? "#10b981" : "#d1d5db",
                borderRadius: "8px",
                padding: "8px 12px",
                cursor: "pointer",
                textAlign: "center",
            ...
            <button
              ...
              style={{
                background:
                  state.playMode === "competitive" ? "#ef4444" : "white",
                color: state.playMode === "competitive" ? "white" : "#1f2937",
                border: "2px solid",
                borderColor:
                  state.playMode === "competitive" ? "#ef4444" : "#d1d5db",
                borderRadius: "8px",
                padding: "8px 12px",
                cursor: "pointer",
                textAlign: "center",
