...
function MusicDemoControls() {
  ...
  const [selectedCelebration, setSelectedCelebration] =
    useState<CelebrationType>("standard");
  ...
  const handleTemperature = useCallback(() => {
    music.setTemperature(
      selectedTemperature === "neutral" ? null : selectedTemperature,
    );
    ...
    >
      ...
      <div data-section="status">
        ...
        >
          ...
          <span>
            {music.isHintActive ? `✅ (${music.hintRegionId})` : "❌"}
          </span>
          ...
          {celebrationTypes.map((type) => (
            <button
              ...
              className={css({
                ...
                border: "2px solid",
                borderColor:
                  selectedCelebration === type ? "blue.500" : "gray.300",
      ...
      <div data-section="temperature">
        <h3 className={css({ fontWeight: "bold", mb: "2" })}>
          Temperature (Hot/Cold Feedback)
        </h3>
        <select
          data-element="temperature-select"
          value={selectedTemperature}
          onChange={(e) =>
            setSelectedTemperature(e.target.value as FeedbackType | "neutral")
          }
          className={css({
            width: "100%",
            padding: "2",
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <li>
                Click &quot;Enable Music&quot; or &quot;Play&quot; to start the
                music
              </li>
              <li>
                Change regions in the Storybook controls to hear different
                continental presets
              </li>
              <li>Use the celebration buttons to trigger sound effects</li>
              <li>
                Apply temperature effects to hear the music become
                brighter/darker
              </li>
              <li>
                Some regions (India, Ireland, Louisiana, Tennessee) have
                hyper-local hints that fade in after a delay
              </li>
            </ol>
          </div>
        </div>
