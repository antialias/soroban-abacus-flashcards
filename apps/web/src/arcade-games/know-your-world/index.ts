...
const manifest: GameManifest = {
  ...
  icon: "🌍",
  description:
    "Test your geography knowledge by finding countries and states on the map!",
...
function validateKnowYourWorldConfig(
  config: unknown,
): config is KnowYourWorldConfig {
  ...
  return (
    ...
    config.includeSizes.every(
      (s: unknown) => typeof s === "string" && validSizes.includes(s),
    ) &&
