/**
 * Hot/Cold Feedback Styling Utilities
 *
 * Utility functions for calculating visual styles based on hot/cold feedback.
 * Used by magnifier borders, crosshairs, and other heat-reactive UI elements.
 */
...
export interface HeatBorderColors {
  border: string
  glow: string
  width: number
}
