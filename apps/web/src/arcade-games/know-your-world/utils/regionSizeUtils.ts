 ...
 */
export function getAllLevelsForCriteria<T extends FilterLevel>(
 ...
 */
export function levelsToRange<T extends FilterLevel>(
  levels: T[],
  allLevels: T[],
): [T, T] {
 ...
 * Works with any filter criteria (size, importance, population).
 */
export function rangeToLevels<T extends FilterLevel>(
  min: T,
  max: T,
  allLevels: T[],
): T[] {
 ...
 */
export function importanceToRange(
 ...
 */
export function rangeToImportance(
  min: ImportanceLevel,
  max: ImportanceLevel,
): ImportanceLevel[] {
 ...
 */
export function populationToRange(
 ...
 */
export function rangeToPopulation(
  min: PopulationLevel,
  max: PopulationLevel,
): PopulationLevel[] {
