  ...
  return (
    <div data-section="strategy">
      ...
      >
        ...
        >
          White controls the center with mobile pieces creating flexible capture
          opportunities
        </p>
      </div>
      ...
      >
        ...
        >
          White pieces 4, 5, 6 form a helper network that can capture
          Black&apos;s 9 (4+5=9)
        </p>
      </div>
      ...
      >
        ...
        >
          White pieces 6, 9, 12 in enemy territory form an arithmetic
          progression (difference = 3)
        </p>
      </div>
      ...
      >
        ...
        >
          White pieces clustered together are all vulnerable to the same Black
          attacker
        </p>
      </div>
      ...
      >
        ...
        >
          White sacrifices a low-value piece to gain tempo and advance the
          Pyramid
        </p>
      </div>
    </div>
