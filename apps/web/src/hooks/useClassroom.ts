...
export function useUpdateClassroom() {
  ...
  return useMutation({
    mutationFn: ({
      classroomId,
      ...params
    }: UpdateClassroomParams & { classroomId: string }) =>
...
async function createEnrollmentRequest(params: {
  ...
  const res = await api(
    `classrooms/${params.classroomId}/enrollment-requests`,
    {
      method: "POST",
      headers: { "Content-Type": "application/json" },
 ...
 */
async function unenrollStudent(params: {
  classroomId: string;
  playerId: string;
}): Promise<void> {
  const res = await api(
    `classrooms/${params.classroomId}/enrollments/${params.playerId}`,
    {
      method: "DELETE",
    },
  );
 ...
 */
async function fetchPendingApprovalsForParent(): Promise<
  EnrollmentRequestWithRelations[]
> {
 ...
 */
async function denyRequestAsParent(
  requestId: string,
): Promise<EnrollmentRequest> {
 ...
 */
async function fetchClassroomPresence(
  classroomId: string,
): Promise<PresenceStudent[]> {
 ...
 */
async function leaveClassroom(params: {
  classroomId: string;
  playerId: string;
}): Promise<void> {
  const res = await api(
    `classrooms/${params.classroomId}/presence/${params.playerId}`,
    {
      method: "DELETE",
    },
  );
 ...
 */
async function fetchStudentPresence(
  playerId: string,
