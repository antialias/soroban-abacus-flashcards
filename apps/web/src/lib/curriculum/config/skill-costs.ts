...
/**
 * Mastery states that affect cognitive load.
 *
 * - 'effortless': Fluent + recently practiced - automatic recall
 * - 'fluent': Solid but needs warming up
 * - 'rusty': Was fluent but needs rebuilding
 * - 'practicing': Learning, not yet fluent
 * - 'not_practicing': Not in rotation - maximum cognitive load
 */
export type MasteryState = 'effortless' | 'fluent' | 'rusty' | 'practicing' | 'not_practicing'
...
export const MASTERY_MULTIPLIERS: Record<MasteryState, number> = {
  /** Fluent + practiced within 14 days - automatic recall */
  effortless: 1,
  /** Fluent + practiced 14-30 days ago - solid but warming up */
  fluent: 2,
  /** Fluent but >30 days since practice - needs rebuilding */
  rusty: 3,
  /** In practice rotation but not yet fluent */
  practicing: 3,
