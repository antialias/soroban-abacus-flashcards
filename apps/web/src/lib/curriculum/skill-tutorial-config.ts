...
export const SKILL_TUTORIAL_CONFIGS: Record<string, SkillTutorialConfig> = {
  ...
  "basic.directSubtraction": {
    ...
    description:
      "The simplest way to subtract: just pull down the earth beads you need to remove.",
    exampleProblems: [
      { start: 3, target: 2 },
      { start: 4, target: 1 },
      { start: 4, target: 0 },
  ...
  "basic.simpleCombinationsSub": {
    ...
    description:
      "When subtracting from 6-9, you may need to move both heaven and earth beads.",
    exampleProblems: [
      { start: 6, target: 0 },
      { start: 7, target: 1 },
      { start: 9, target: 3 },
  ...
  "tenComplementsSub.-8=+2-10": {
    ...
    title: "-8 = +2 - 10",
    description:
      "When you can't subtract 8 directly, use 10's friend: borrow 10, then add 2 back.",
    exampleProblems: [
      { start: 10, target: 2 },
      { start: 11, target: 3 },
      { start: 15, target: 7 },
  ...
  "tenComplementsSub.-7=+3-10": {
    ...
    title: "-7 = +3 - 10",
    description:
      "When you can't subtract 7 directly, use 10's friend: borrow 10, then add 3 back.",
    exampleProblems: [
      { start: 10, target: 3 },
      { start: 11, target: 4 },
      { start: 15, target: 8 },
  ...
  "tenComplementsSub.-6=+4-10": {
    ...
    title: "-6 = +4 - 10",
    description:
      "When you can't subtract 6 directly, use 10's friend: borrow 10, then add 4 back.",
    exampleProblems: [
      { start: 10, target: 4 },
      { start: 11, target: 5 },
      { start: 15, target: 9 },
  ...
  "tenComplementsSub.-5=+5-10": {
    ...
    title: "-5 = +5 - 10",
    description:
      "When you can't subtract 5 directly, use 10's friend: borrow 10, then add 5 back.",
    exampleProblems: [
      { start: 10, target: 5 },
      { start: 11, target: 6 },
      { start: 14, target: 9 },
  ...
  "tenComplementsSub.-4=+6-10": {
    ...
    title: "-4 = +6 - 10",
    description:
      "When you can't subtract 4 directly, use 10's friend: borrow 10, then add 6 back.",
    exampleProblems: [
      { start: 10, target: 6 },
      { start: 11, target: 7 },
      { start: 13, target: 9 },
  ...
  "tenComplementsSub.-3=+7-10": {
    ...
    title: "-3 = +7 - 10",
    description:
      "When you can't subtract 3 directly, use 10's friend: borrow 10, then add 7 back.",
    exampleProblems: [
      { start: 10, target: 7 },
      { start: 11, target: 8 },
      { start: 12, target: 9 },
  ...
  "tenComplementsSub.-2=+8-10": {
    ...
    title: "-2 = +8 - 10",
    description:
      "When you can't subtract 2 directly, use 10's friend: borrow 10, then add 8 back.",
    exampleProblems: [
      { start: 10, target: 8 },
      { start: 11, target: 9 },
    ],
 ...
 */
export function getSkillTutorialConfig(
  skillId: string,
): SkillTutorialConfig | null {
