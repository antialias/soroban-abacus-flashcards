 ...
 */
export const CalibrationOverlay = forwardRef<CalibrationOverlayHandle, CalibrationOverlayProps>(
  function CalibrationOverlay(
    ...
    const lerpCorners = (a: QuadCorners, b: QuadCorners, t: number): QuadCorners => ({
