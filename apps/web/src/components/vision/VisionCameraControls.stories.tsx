        ...
        >
          <div>
            ...
            <p className={css({ color: "gray.400", fontSize: "sm", mb: 2 })}>
              The camera dropdown now shows even with just 1 camera, so you can
              always see which device is selected.
            </p>
            <VisionCameraControls
              cameraSource="local"
              availableDevices={singleCamera}
          ...
          <div>
            ...
            <p className={css({ color: "gray.400", fontSize: "sm", mb: 2 })}>
              The torch button works for both local and remote cameras. It
              automatically controls the active camera&apos;s flash.
            </p>
          ...
          <div>
            ...
            <p className={css({ color: "gray.400", fontSize: "sm", mb: 2 })}>
              ...
              <code
                className={css({ bg: "gray.700", px: 1, borderRadius: "sm" })}
              >
                zoom: &#123; ideal: 1 &#125;
              </code>{" "}
