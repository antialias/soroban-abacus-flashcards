...
const tutorialSteps: TutorialStep[] = [
  ...
  },
  {
    ...
    tooltip: {
      ...
      explanation:
        "Continue adding earth beads one by one for numbers 2, 3, and 4",
    },
    errorMessages: {
  ...
  },
  {
    ...
    tooltip: {
      ...
      explanation:
        "Four earth beads is the maximum - next we need a different approach",
    },
    errorMessages: {
      wrongBead: "Click the highlighted earth bead",
      wrongAction: "Move the bead UP to add it",
  ...
  },
  {
    ...
    tooltip: {
      ...
      explanation:
        "When you have room in the earth section, simply add directly",
    },
    errorMessages: {
  ...
  // Phase 3: Five Complements (when earth section is full)
  {
    ...
    problem: "3 + 4",
    description:
      "Need to add 4, but only have 1 earth bead space. Use complement: 4 = 5 - 1",
    startValue: 3,
    targetValue: 7,
    highlightBeads: [
    ...
    tooltip: {
      ...
      explanation:
        "When you need to add 4 but only have 1 space, use: add 5, remove 1",
    },
    errorMessages: {
      wrongBead:
        "Follow the two-step process: heaven bead first, then remove earth bead",
  ...
  },
  {
    ...
    tooltip: {
      ...
      explanation:
        "Even with space for 2, using complement for 4 is more efficient",
    },
    errorMessages: {
      wrongBead:
        "Use the complement method: heaven bead, then remove earth bead",
  ...
  },
  {
    ...
    problem: "4 + 2",
    description:
      "Add 2 when you have no earth space. Use complement: 2 = 5 - 3",
    startValue: 4,
    targetValue: 6,
    highlightBeads: [
      { placeValue: 0, beadType: "heaven" },
    ...
    tooltip: {
      ...
      explanation:
        "To add 2 when earth section is full: add 5, then subtract 3",
    },
    errorMessages: {
  ...
  },
  {
    ...
    tooltip: {
      ...
      explanation:
        "To add 1 when no space: add 5, then subtract 4 (remove all earth beads)",
    },
    errorMessages: {
...
const practiceSteps: PracticeStep[] = [
  ...
  },
  {
    ...
    description:
      "Practice using the heaven bead (5) and combining it with earth beads",
    skillLevel: "heaven",
    problemCount: 15,
    maxTerms: 3,
  },
...
function generateComplementProblems(
  count: number,
  maxTerms: number,
): Problem[] {
  const problems: Problem[] = [];
...
export function GuidedAdditionTutorial() {
  ...
  const updateProblemAnswer = useCallback(
    (problemId: string, answer: number) => {
  ...
  const checkPracticeWork = useCallback(() => {
    ...
    setTimeout(() => {
      ...
      if (incorrectProblems.length === 0) {
        ...
        setShowPracticeResults(false);
        setFeedback(
          `${incorrectProblems.length} problem(s) need correction. Try again!`,
        );
    ...
    if (isPracticeStep(currentStep)) {
      ...
      switch (step.skillLevel) {
        ...
        case "heaven":
          ...
          break;
        case "five-complements":
          problems = generateComplementProblems(
            step.problemCount,
            step.maxTerms,
          );
          break;
  ...
  const resetTutorial = useCallback(() => {
    ...
    setCurrentValue(
      combinedSteps[0] && isTutorialStep(combinedSteps[0])
        ? combinedSteps[0].startValue
        : 0,
    );
    setFeedback(null);
    setIsCorrect(false);
                ...
                {currentStep.multiStepInstructions.map((instruction, index) => (
                  <li
                    ...
                    className={css({
                      ...
                      fontWeight:
                        index === multiStepProgress ? "semibold" : "normal",
                    })}
                  >
                    {index + 1}. {instruction}
                  </li>
