 ...
 */
export const FlowchartModal = forwardRef<HTMLDivElement, FlowchartModalProps>(function FlowchartModal(
  {
    flowchart,
    onSubmit,
    onClose,
  ...
  const tierCounts = useMemo(() => {
    ...
    const scores = internalExamples.map((ex) => ex.complexity.decisions + ex.complexity.checkpoints)
    ...
    >
      ...
      >
        ...
        <Dialog.Description className={css({ srOnly: true })}>
          Practice, view flowchart diagram, or generate worksheets for {flowchart.definition.title}
        </Dialog.Description>
      </div>
