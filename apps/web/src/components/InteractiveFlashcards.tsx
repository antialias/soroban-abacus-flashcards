...
function DraggableCard({ card, containerRef }: DraggableCardProps) {
  ...
  const handlePointerMove = (e: React.PointerEvent) => {
    ...
    const crossProduct =
      grabOffsetRef.current.x * deltaY - grabOffsetRef.current.y * deltaX;
    ...
    const rotatedGrabX =
      grabOffsetRef.current.x * cosRot - grabOffsetRef.current.y * sinRot;
    const rotatedGrabY =
      grabOffsetRef.current.x * sinRot + grabOffsetRef.current.y * cosRot;
