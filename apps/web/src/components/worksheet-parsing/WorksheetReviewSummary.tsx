...
import type { ReviewProgress, ParsedProblem, WorksheetParsingResult } from '@/lib/worksheet-parsing'
      ...
      >
        ...
        <button
          ...
          className={css({
            ...
            fontWeight: 'semibold',
            color: 'white',
            backgroundColor: primaryAction.variant === 'success' ? 'green.600' : 'blue.600',
            border: 'none',
            borderRadius: 'lg',
            cursor: 'pointer',
            _hover: {
              backgroundColor: primaryAction.variant === 'success' ? 'green.700' : 'blue.700',
            },
            _disabled: {
              opacity: 0.6,
              cursor: 'wait',
        ...
        >
          {isApproving || isInitializing ? 'Processing...' : primaryAction.label}
        </button>
        ...
        {totalWorksheets > 1 && worksheetIndex < totalWorksheets && onNextWorksheet && (
          <button
            type="button"
