...
const fiveComplementsPracticeStep = {
  ...
  description:
    "Practice using five complement techniques when earth section is full",
  problemCount: 15,
  maxTerms: 4,
  allowedSkills: {
    basic: {
...
const tenComplementsPracticeStep = {
  ...
  description:
    "Practice advanced carrying operations using ten complement techniques",
  problemCount: 20,
  maxTerms: 5,
  allowedSkills: {
    basic: {
...
export const WithoutDelete: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Practice step editor without delete functionality (onDelete prop omitted).",
      },
    },
  },
};
