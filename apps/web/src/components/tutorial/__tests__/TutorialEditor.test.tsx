...
const renderTutorialEditor = (
  props: Partial<React.ComponentProps<typeof TutorialEditor>> = {},
) => {
  const defaultProps = {
...
describe("TutorialEditor", () => {
  ...
  describe("Initial Rendering", () => {
    it("renders tutorial information in read-only mode by default", () => {
      ...
      expect(
        screen.getByText("A test tutorial for editing"),
      ).toBeInTheDocument();
  ...
  describe("Edit Mode Toggle", () => {
    ...
    it("shows form inputs in edit mode", () => {
      ...
      expect(
        screen.getByDisplayValue("A test tutorial for editing"),
      ).toBeInTheDocument();
  ...
  describe("Validation Display", () => {
    ...
    it("shows validation warnings", async () => {
      ...
      await waitFor(() => {
        expect(
          screen.getByText("Description could be longer"),
        ).toBeInTheDocument();
      });
    });
