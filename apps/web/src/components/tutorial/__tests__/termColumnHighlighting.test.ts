...
describe('Term-to-Column Highlighting Integration', () => {
  ...
  it('should use correct styling for dynamic column highlights', () => {
    ...
    const staticBeadStyle = { fill: '#fbbf24', stroke: '#f59e0b', strokeWidth: 3 } // Orange
    expect(expectedDynamicColumnStyle.columnPost.stroke).not.toBe(staticBeadStyle.stroke)
  })
})