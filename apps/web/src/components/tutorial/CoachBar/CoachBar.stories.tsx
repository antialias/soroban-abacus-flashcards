        ...
        <TutorialUIProvider initialSegment={segment} canHideCoachBar={canHide}>
          <div style={{ height: "400px", background: "#f5f5f5" }}>
            ...
            <div style={{ padding: "20px", marginTop: "20px" }}>
              ...
              <p>
                This simulates the tutorial content that would appear below the
                Coach Bar.
              </p>
              <p>
                The Coach Bar is sticky positioned and will stay at the top when
                scrolling.
              </p>
              <div
                style={{
  ...
  decorators: [
    (_Story) => {
      return (
        ...
        >
          <div
            style={{ height: "200px", background: "#f5f5f5", padding: "20px" }}
          >
            <p>
              <strong>Coach Bar is hidden</strong>
            </p>
            <p>
              This shows the tutorial content when the Coach Bar has been
              dismissed.
            </p>
            <p>
              You can toggle the Coach Bar visibility in the Controls panel.
            </p>
          </div>
        </TutorialUIProvider>
      );
      ...
      return (
        <TutorialUIProvider initialSegment={null} canHideCoachBar>
          ...
          >
            ...
            <p>
              When there's no active segment or no summary, the Coach Bar
              doesn't render.
            </p>
          </div>
        </TutorialUIProvider>
        ...
        <TutorialUIProvider initialSegment={segments[0]} canHideCoachBar>
          <div style={{ height: "400px", background: "#f5f5f5" }}>
            ...
            <div style={{ padding: "20px" }}>
              ...
              <p>
                The Coach Bar updates as you progress through tutorial steps.
              </p>
