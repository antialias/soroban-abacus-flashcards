      ...
      <HoverCard.Trigger asChild>
        <div
          style={{
            ...
            margin: "4px",
            opacity:
              ui.hintFocus === "none" || ui.hintFocus === "bead" ? 1 : 0.5,
...
const createMockSegment = (
  overrides: Partial<PedagogicalSegment> = {},
): PedagogicalSegment => ({
  id: "demo-segment",
  place: 1,
  digit: 5,
  ...
  const segments = [
    createMockSegment({
      ...
      readable: {
        ...
        summary:
          "Add 3 to the ones place. It fits here, so just move 3 lower beads.",
        chips: [
          { label: "Digit", value: "3" },
    ...
    createMockSegment({
      ...
      readable: {
        ...
        summary:
          "Add 7 to the ones place using 5's friend: press the heaven bead (5) and lift 2.",
        chips: [
    ...
    createMockSegment({
      ...
      readable: {
        ...
        summary:
          "Add 8 to the ones place to make 10. Carry to tens place, then take 2 here.",
        chips: [
  ...
  return (
    <div style={{ height: "100vh", backgroundColor: "#f9fafb" }}>
      ...
      <div style={{ padding: "20px" }}>
        ...
        <p>
          This demonstrates the Coach Bar and single-owner tooltip gate working
          together.
        </p>
        ...
        >
          ...
          {ui.hintFocus !== "none" && (
            <span
              style={{ marginLeft: "10px", fontSize: "12px", color: "#6b7280" }}
            >
        ...
        <div style={{ marginBottom: "30px" }}>
            ...
            {segments.map((segment, index) => (
              <button
                ...
                style={{
                  padding: "8px 16px",
                  backgroundColor:
                    currentSegment.id === segment.id ? "#3b82f6" : "#e5e7eb",
                  color: currentSegment.id === segment.id ? "white" : "#374151",
                  border: "none",
                  borderRadius: "6px",
                  cursor: "pointer",
                  fontWeight:
                    currentSegment.id === segment.id ? "bold" : "normal",
                }}
              >
                Step {index + 1}
              </button>
          ...
          <p style={{ fontSize: "14px", color: "#6b7280" }}>
            Click the steps above to see how the Coach Bar updates with
            different content.
          </p>
        </div>
        ...
        >
          ...
          <ol style={{ margin: 0, paddingLeft: "20px", color: "#92400e" }}>
            ...
            <li>
              While keeping mouse over the term, try hovering a green bead →
              bead tooltip is blocked
            </li>
            <li>Move mouse away from term → term tooltip closes</li>
            <li>
              Now hover over a green bead → bead tooltip opens successfully
            </li>
