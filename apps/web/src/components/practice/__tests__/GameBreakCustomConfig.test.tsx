...
describe("GameBreakCustomConfig", () => {
  ...
  describe("Visibility", () => {
    it("should not render when no game is selected", () => {
      ...
      expect(
        container.querySelector('[data-element="game-break-customize"]'),
      ).toBeNull();
    });
      ...
      const TestComponent = () => {
        ...
        return (
          <div>
            ...
            <div data-testid="show-customize">
              {String(context.gameBreakShowCustomize)}
            </div>
          </div>
        );
      };
  ...
  describe("Field Interactions", () => {
    it("should update boolean field when clicking Yes/No", () => {
        ...
        return (
          <div>
            ...
            <div data-testid="custom-config">
              {JSON.stringify(context.gameBreakCustomConfig)}
            </div>
          </div>
        );
      };
      ...
      expect(JSON.parse(configText ?? "{}")).toHaveProperty(
        "showNumbers",
        true,
      );
    });
  ...
  describe("Resolved Config Integration", () => {
    it("should update resolvedGameConfig when custom config changes", () => {
        ...
        return (
          <div>
            ...
            <div data-testid="resolved-config">
              {JSON.stringify(context.resolvedGameConfig)}
            </div>
          </div>
        );
      };
      ...
      expect(JSON.parse(resolvedText ?? "{}")).toHaveProperty(
        "selectedCount",
        8,
      );
    });
