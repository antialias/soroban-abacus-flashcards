...
export function OfflineSessionModal({
  ...
  const [selectedTypes, setSelectedTypes] = useState<Set<PracticeTypeId>>(
    new Set(["abacus"]),
  );
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
      ...
      const response = await fetch(
        `/api/curriculum/${playerId}/offline-sessions`,
        {
          method: "POST",
          body: formData,
        },
        ...
        <div className={css({ p: 5 })}>
              ...
              {PRACTICE_TYPES.map((type) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Icon */}
                    <span className={css({ fontSize: "xl", flexShrink: 0 })}>
                      {type.icon}
                    </span>
          ...
          <div className={css({ mb: 5 })}>
            ...
            >
              ...
              <span
                className={css({ color: "gray.400", fontWeight: "normal" })}
              >
                (optional)
              </span>
            </label>
