...
export function GameBreakScreen({
  ...
  const [autoStartGameName, setAutoStartGameName] = useState<string | null>(
    null,
  );
        ...
        <GameLayoutProvider mode="container">
          <PracticeGameModeProvider
            ...
            onGameComplete={(gameState) =>
              handleComplete("gameFinished", gameState)
            }
          >
            <Provider>
              <GameComponent />
      ...
      >
        ...
        {phase === "auto-starting" && autoStartGameName && (
          ...
          >
            ...
            >
              Playing{" "}
              {getGame(autoStartGameName)?.manifest.displayName ?? "Game"}!
            </span>
            <span
              className={css({
                fontSize: "0.875rem",
            ...
            {availableGames.map((game) => {
              ...
              return (
                ...
                >
                  ...
                  <span className={css({ fontSize: "2rem" })}>
                    {game.manifest.icon}
                  </span>
                  <span
                    className={css({
