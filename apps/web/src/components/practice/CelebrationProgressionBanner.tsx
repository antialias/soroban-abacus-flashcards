...
// --- Button Box Shadows ---
const CELEBRATION_BTN_SHADOW: BoxShadow[] = [
  boxShadow(0, 4, 15, 0, 245, 158, 11, 0.4),
];
...
function calculateStyles(
  ...
  const normalBorder = isDark
    ? COLORS.normalBorderDark
    : COLORS.normalBorderLight;
  const celebrationTitle = isDark
    ? COLORS.celebrationTitleDark
    : COLORS.celebrationTitleLight;
  ...
  const normalSubtitle = isDark
    ? COLORS.normalSubtitleDark
    : COLORS.normalSubtitleLight;
  const celebrationBtnText = isDark
    ? COLORS.celebrationBtnTextDark
    : COLORS.celebrationBtnTextLight;
  ...
  return {
    // Container
    containerBackground: gradientToCss(
      135,
      lerpGradientStops(celebrationBg, normalBg, t),
    ),
    ...
    containerBoxShadow: boxShadowsToCss(
      lerpBoxShadows(CELEBRATION_SHADOWS, NORMAL_SHADOWS, t),
    ),
    ...
    buttonBackground: gradientToCss(
      135,
      lerpGradientStops(celebrationBtn, NORMAL_BTN, t),
    ),
    buttonBorderRadius: lerp(12, 0, t),
    buttonBoxShadow: boxShadowsToCss(
      lerpBoxShadows(CELEBRATION_BTN_SHADOW, NORMAL_BTN_SHADOW, t),
    ),
