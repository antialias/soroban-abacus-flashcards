 ...
 */
function generateGridProblems(rows: number, cols: number, count?: number): CompletedProblem[] {
...
function StreamingDemo({
  ...
  const Overlay =
    variant === 'compact' ? ProgressiveHighlightOverlayCompact : ProgressiveHighlightOverlay
...
function RestartDemo() {
  ...
  return (
    <div>
      ...
      <ProgressiveHighlightOverlay key={key} completedProblems={problems} staggerDelay={50} />
    </div>
  )
}
  ...
  return (
    ...
    >
      <div>
        ...
        >
          <ProgressiveHighlightOverlay completedProblems={problems} staggerDelay={50} />
        </div>
      </div>
      ...
      <div>
        ...
        >
          <ProgressiveHighlightOverlayCompact completedProblems={problems} staggerDelay={50} />
        </div>
      </div>
    </div>
  )
