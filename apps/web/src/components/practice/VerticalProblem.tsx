...
export function VerticalProblem({
  ...
  const isCorrect =
    ...
    numericUserAnswer === correctAnswer;
  const isIncorrect =
    isCompleted &&
    correctAnswer !== undefined &&
    numericUserAnswer !== correctAnswer;
  ...
  return (
    <div
      ...
      data-status={
        isCompleted ? (isCorrect ? "correct" : "incorrect") : "active"
      }
      className={css({
        display: "flex",
    ...
    >
      ...
      {terms.map((term, index) => {
        ...
        const isInPrefixSum =
          currentHelpTermIndex !== undefined && index < currentHelpTermIndex;
        ...
        return (
          <div
            ...
            data-term-status={
              isCurrentHelp ? "current" : showNeedHelp ? "need-help" : "pending"
            }
            className={css({
              display: "flex",
              alignItems: "center",
          ...
          >
            ...
            {isVisualDebugEnabled &&
              (() => {
                ...
                const isOverBudget =
                  complexityBudget !== undefined &&
                  cost !== undefined &&
                  cost > complexityBudget;
                const skills = traceStep.skillsUsed;

                // Calculate base cost sum for comparison (without mastery multipliers)
                const baseCostSum = skills.reduce(
                  (sum, s) => sum + getBaseComplexity(s),
                  0,
                );
        ...
        >
          ...
          {Array(maxDigits)
            ...
            .map((_, index) => {
              ...
              const isRejectedCell =
                rejectedDigit && isEmpty && index === nextDigitIndex;
              ...
              return (
                <div
                  ...
                  className={css({
                    ...
                    borderRadius: "4px",
                    border:
                      isEmpty && !isCompleted && !isRejectedCell
                        ? "1px dashed"
                        : "1px solid",
