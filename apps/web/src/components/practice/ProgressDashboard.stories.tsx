...
const beginnerPhase: CurrentPhaseInfo = {
  ...
  description:
    "Learning to add single digits using direct addition on the abacus",
...
const intermediatePhase: CurrentPhaseInfo = {
  ...
  description:
    "Using the five complement technique when direct addition is not possible",
  skillsToMaster: [
...
const advancedPhase: CurrentPhaseInfo = {
  ...
  description:
    "Learning to carry over using ten complements for multi-digit addition",
  skillsToMaster: [
    ...
    <DashboardWrapper>
      <ProgressDashboard
        ...
        currentPhase={{
          ...
          description:
            "Welcome to soroban practice! Let us begin your math journey.",
