...
export function PlanReview({
  ...
  const reinforceCount = allSlots.filter(
    (s) => s.purpose === "reinforce",
  ).length;
  const reviewCount = allSlots.filter((s) => s.purpose === "review").length;
  const challengeCount = allSlots.filter(
    (s) => s.purpose === "challenge",
  ).length;
      ...
      {showConfig && (
        ...
        >
          ...
          >
            ...
            <div>
              <strong>Target Duration:</strong> {plan.targetDurationMinutes}{" "}
              minutes
            </div>
            <div>
            ...
            <div>
              <strong>Avg Time/Problem:</strong> {plan.avgTimePerProblemSeconds}
              s
            </div>
            <div>
            ...
            {parts.map((part: SessionPart) => (
              <details key={part.partNumber}>
                <summary
                  className={css({ cursor: "pointer", fontWeight: "bold" })}
                >
                  Part {part.partNumber}: {part.type} ({part.slots.length}{" "}
                  slots)
                </summary>
                <div
                  className={css({ marginTop: "0.5rem", marginLeft: "1rem" })}
                >
                      ...
                      >
                        ...
                        {slot.constraints && (
                          ...
                          >
                            ...
                            {slot.constraints.digitRange?.min}-
