...
function ProblemDetailPopover({
  ...
  const position = result
    ? allResults.findIndex(
        (r) =>
          r.partNumber === result.partNumber &&
          r.slotIndex === result.slotIndex,
      )
    : allResults.length;
  const previousResults = allResults.slice(0, position);
      ...
      >
            ...
            <span
              className={css({
                ...
                backgroundColor: isDark
                  ? `${purposeInfo.color}.900`
                  : `${purposeInfo.color}.100`,
                color: isDark
                  ? `${purposeInfo.color}.200`
                  : `${purposeInfo.color}.700`,
              })}
            >
        ...
        >
          ...
          {result && (
            ...
            >
              <span
                className={css({ color: isDark ? "gray.400" : "gray.600" })}
              >
                Response time:
              </span>
              <span
