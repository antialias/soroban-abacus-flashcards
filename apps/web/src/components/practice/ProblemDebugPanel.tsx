...
export function ProblemDebugPanel({
  ...
  const maxBudget =
    trace?.budgetConstraint ?? slot.constraints?.maxComplexityBudgetPerTerm;
  const minBudget =
    trace?.minBudgetConstraint ?? slot.constraints?.minComplexityBudgetPerTerm;
          ...
          >
            ...
            >
              ...
              >
                ...
                {totalCost !== undefined && (
                  <span className={css({ color: "#4ade80" })}>
                    total: {totalCost}
                  </span>
                )}
              </div>
              ...
              >
                {minBudget !== undefined ? (
                  <span className={css({ color: "#f472b6" })}>
                    min {minBudget}/term{" "}
                    <span className={css({ color: "#6b7280" })}>
                      (1st exempt)
                    </span>
                  </span>
                ) : (
                  ...
                  return (
                    ...
                    >
                      ...
                      <span
                        ...
                        title={
                          isExemptFromMin
                            ? "First term exempt from min budget"
                            : undefined
                        }
                      >
                        {cost !== undefined ? `${cost}` : "—"}
