            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    >
                      {PART_TYPES.filter((p) => enabledParts[p.type]).map(
                        ({ type, emoji }) => (
                          <div
                            key={type}
                            data-mode={type}
                        ...
                        >
                          {[5, 10, 15, 20].map((min) => {
                            ...
                            const minutesPerPart =
                              enabledPartTypes.length > 0
                                ? min / enabledPartTypes.length
                                : min;
                            let problems = 0;
              ...
              {showTutorialGate && tutorialConfig && nextSkill && (
                ...
                >
                  ...
                  >
                    <span
                      className={css({ fontSize: "1.5rem", lineHeight: 1 })}
                    >
                      🌟
                    </span>
                    ...
                    >
                      ...
                      <div className={css({ flex: 1 })}>
                        ...
                        >
                          ...
                          {sessionMode.weakSkills.length > 1 ? "s" : ""} that
                          need practice
                        </p>
                        {/* Weak skills badges */}
                        <div
                ...
                >
                  {isNoSkillsError ? (
                    <>
                      ...
                      >
                        Please enable at least one skill in the skill selector
