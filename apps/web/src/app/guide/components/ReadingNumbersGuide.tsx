  ...
  return (
    <div className={stack({ gap: "12" })}>
      ...
      <div className={css({ textAlign: "center" })}>
        ...
        >
          Master the fundamentals of reading numbers on the soroban with
      ...
      >
        <div className={stack({ gap: "6" })}>
          ...
          <div className={stack({ gap: "6" })}>
            ...
            >
              The soroban consists of two main sections divided by a horizontal
              bar. Understanding this structure is fundamental to reading any
              number.
            </p>
            ...
            >
              ...
              >
                💡 Key Concept: Active beads are those touching the horizontal
                bar
              </p>
            </div>
          </div>
      ...
      >
        <div className={stack({ gap: "6" })}>
          ...
          >
            Let's learn to read single digits by understanding how heaven and
            earth beads combine to represent numbers 1 through 9.
          </p>
      ...
      >
        <div className={stack({ gap: "6" })}>
          ...
          >
            Reading larger numbers is simply a matter of reading each column
            from left to right, with each column representing a different place
            value.
          </p>
      ...
      >
        <div className={stack({ gap: "6" })}>
          ...
          >
            Try the interactive abacus below! Click on the beads to activate
            them and watch the number change in real-time.
          </p>
