...
// Reducer function
function memoryPairsReducer(
  state: MemoryPairsState,
  action: MemoryPairsAction,
): MemoryPairsState {
  switch (action.type) {
    ...
    case "FLIP_CARD": {
      const cardToFlip = state.gameCards.find(
...
// Create context
export const MemoryPairsContext = createContext<MemoryPairsContextValue | null>(
  null,
);
