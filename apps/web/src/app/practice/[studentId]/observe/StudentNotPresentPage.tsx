      ...
      if (data.created > 0) {
        ...
        if (reason === "pending_prompt_exists") {
          showError(
            ...
            `${studentName} already has a pending entry prompt.`,
          );
        } else if (reason === "already_present") {
          showSuccess(
            "Already in classroom",
            `${studentName} is now in the classroom!`,
          );
        } else {
    ...
    <PageWithNav>
      ...
      >
        ...
        >
          ...
          >
            {studentName} is enrolled in your class, but you can only observe
          ...
          {!promptSent ? (
            ...
            >
              ...
              >
                Send a notification to {studentName}&apos;s parent asking them
          ...
          >
            ...
            >
              <li>
                Have {studentName} open their device and go to{" "}
                <strong>Join Classroom</strong>
              </li>
              <li>They enter your classroom code to join</li>
              <li>
                Once they appear in your classroom dashboard, you can observe
                their session
              </li>
            </ol>
          </div>
