...
const VisionRecordingPlayer = dynamic(
  () =>
    import("@/components/vision/VisionRecordingPlayer").then(
      (m) => m.VisionRecordingPlayer,
    ),
  { ssr: false },
);
...
export function SummaryClient({
  ...
  const { data: recordingData, isLoading: isLoadingRecording } =
    useSessionRecording(studentId, session?.id ?? "");
                        ...
                        recordingData.recording?.durationMs && (
                          ...
                          >
                            ...
                            <VisionRecordingPlayer
                              ...
                              problemMarkers={
                                recordingData.recording.problemMarkers
                              }
                            />
                          </div>
                        )}
