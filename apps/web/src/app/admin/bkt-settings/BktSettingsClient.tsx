 ...
 */
async function fetchStudentProblemHistory(
  studentId: string,
...
export function BktSettingsClient({ students }: BktSettingsClientProps) {
  ...
  const [viewMode, setViewMode] = useState<"aggregate" | "student">(
    "aggregate",
  );
  ...
  const hasChanges =
    previewThreshold !== null && previewThreshold !== savedThreshold;
      ...
      >
        <div className={css({ maxWidth: "800px", margin: "0 auto" })}>
          ...
          <header className={css({ marginBottom: "2rem" })}>
            ...
            >
              Configure how much evidence is required before trusting skill
              classifications.
            </p>
          </header>
          ...
          >
            ...
            <div className={css({ marginBottom: "1.5rem" })}>
              <label
                className={css({ display: "block", marginBottom: "0.75rem" })}
              >
                <span
                  className={css({
                    fontWeight: "600",
                ...
                >
                  Higher values require more practice data before classifying
                  skills.
                </span>
              </label>
              <div
            ...
            >
              ...
              {hasChanges && (
                <span
                  className={css({ fontSize: "0.875rem", color: "orange.500" })}
                >
                  Unsaved changes
                </span>
              )}
          ...
          >
            ...
            >
              <li>
                <strong>Confidence</strong> measures how much practice data we
                have for a skill
              </li>
              <li>
                Skills below the threshold are classified as{" "}
                <strong>"Developing"</strong> (not enough data)
              </li>
              <li>
                Skills above the threshold are classified by their P(known)
                estimate:
                <ul
                  className={css({
              ...
              <li>
                Lower threshold = more aggressive (classifies skills with less
                data)
              </li>
              <li>
                Higher threshold = more conservative (needs more practice before
                classifying)
              </li>
            </ul>
          </div>
...
function StudentPreview({
  ...
  const { struggling, learning, mastered, hasData } =
    useSkillsByClassification();
  ...
  return (
    <div>
      ...
      >
        {studentName}'s skills at {(previewThreshold * 100).toFixed(0)}%
        confidence:
      </p>
      <div
        className={css({
