...
function GamesPageContent() {
  ...
  const _handleGameClick = (gameType: string) => {
    ...
    console.log(
      "🔄 GamesPage: Navigating with Next.js router (no page reload)",
    );
    ...
    >
      ...
      >
          ...
          >
            ...
            <div
              className={css({
                ...
                bottom: 0,
                background:
                  "linear-gradient(135deg, #dbeafe 0%, #e9d5ff 50%, #fef3c7 100%)",
                opacity: 0.5,
              })}
            />
            ...
            >
              ...
              >
                Select your champions, choose your battles, and dive into
                full-screen arcade action!
              </p>
                ...
                {allPlayers.slice(0, 2).map((player, idx) => (
                  <React.Fragment key={player.id}>
                    ...
                    >
                      ...
                      >
                        {Math.floor(
                          profile.totalWins * (idx === 0 ? 0.6 : 0.4),
                        )}
                      </div>
                      <div
                        className={css({
        ...
        >
          ...
          >
            Start with our interactive guide and unlock the secrets of the
            ancient calculator!
          </p>
          <Link
            href="/guide"
