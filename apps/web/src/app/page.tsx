  ...
  const skillTutorials = [
    ...
    // Skill 2: Multiply & divide (12×34)
    {
      ...
      steps: fullTutorial.steps
        .filter((step) => step.id.includes("complement"))
        .slice(0, 3),
    },
      ...
      <div className={css({ bg: "bg.canvas", minHeight: "100vh" })}>
        ...
        <div className={container({ maxW: "7xl", px: "4", py: "12" })}>
          ...
          <section className={stack({ gap: "6", mb: "16" })}>
            ...
            <div
              className={grid({ columns: { base: 1, sm: 2, lg: 4 }, gap: "5" })}
            >
          ...
          <section
            className={stack({ gap: "6", mb: "16", overflow: "hidden" })}
          >
            <div className={css({ textAlign: "center" })}>
              <h2
                className={css({
...
function FeaturePanel({
  ...
  const borderColor =
    accentColor === "purple" ? "purple.500/30" : "blue.500/30";
      ...
      <div className={stack({ gap: "3", mb: ctaText ? "6" : "0" })}>
        {features.map((feature, i) => (
          <div key={i} className={hstack({ gap: "3" })}>
            <span className={css({ color: "yellow.400", fontSize: "lg" })}>
              ✓
            </span>
