...
export function DependencyCard({
  ...
  if (
    preflightInfo &&
    (!preflightInfo.platform.supported || preflightInfo.venv.error)
  ) {
    const errorMessage =
      preflightInfo.platform.reason || preflightInfo.venv.error;
  ...
  if (preflightInfo && !preflightInfo.dependencies.allInstalled) {
    ...
    return (
      ...
      >
        ...
        <div
          className={css({ color: "yellow.400", mb: 2, fontWeight: "medium" })}
        >
        ...
        {error && (
          <div
            className={css({ fontSize: "sm", color: "red.400", mb: 3, px: 2 })}
          >
            {error}
          </div>
        )}
        ...
        {/* Instructions */}
        <div
          className={css({ fontSize: "xs", color: "gray.500", mb: 4, px: 4 })}
        >
