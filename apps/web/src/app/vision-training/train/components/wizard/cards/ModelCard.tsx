      ...
      {selectedModel && (
        ...
        >
          {selectedModel === "column-classifier" ? (
            <>
              <strong>Column Classifier</strong> selected — trains on cropped
              column images to recognize digits
            </>
          ) : (
            <>
              <strong>Boundary Detector</strong> selected — trains on full
              frames to detect abacus corners
            </>
          )}
        </div>
      )}
