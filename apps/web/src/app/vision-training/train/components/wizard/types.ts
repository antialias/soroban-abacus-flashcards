...
// Data quality levels
export type DataQuality = 'none' | 'insufficient' | 'minimal' | 'good' | 'excellent'
...
export type ColumnClassifierSamplesLegacy = Omit<ColumnClassifierSamples, 'type'>
...
export function isColumnClassifierResult(result: TrainingResult): result is ColumnClassifierResult {
  return result.type === 'column-classifier'
}

export function isBoundaryDetectorResult(result: TrainingResult): result is BoundaryDetectorResult {
