 ...
 */
export function BoundaryDataCapture({ onSamplesCollected }: BoundaryDataCaptureProps) {
  // Capture state
  ...
  const captureElementRef = useRef<HTMLImageElement | HTMLCanvasElement | HTMLVideoElement | null>(
    null
  )
