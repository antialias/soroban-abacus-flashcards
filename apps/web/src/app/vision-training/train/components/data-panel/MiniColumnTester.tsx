 ...
 */
export function MiniColumnTester({
  imagePath,
  groundTruthDigit,
}: MiniColumnTesterProps) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Expected:{" "}
          <span className={css({ fontWeight: "bold", color: "white" })}>
            {groundTruthDigit}
          </span>
        </div>
      </div>
      ...
      <button
        ...
        disabled={
          isRunning || classifier.isLoading || classifier.isModelUnavailable
        }
        className={css({
          w: "100%",
          py: 2,
        ...
        >
          ...
          >
            <div>
              ...
              <span
                className={css({ color: "gray.500", fontSize: "xs", ml: 1 })}
              >
