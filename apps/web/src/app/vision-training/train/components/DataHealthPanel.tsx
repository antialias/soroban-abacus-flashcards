            ...
            <div className={css({ mb: 2 })}>
              <button
                ...
                className={css({
                  ...
                  p: 3,
                  bg: expandedSection === 'sync' || isSyncing ? 'blue.900/30' : 'gray.800',
                  color: 'gray.200',
                  borderRadius: 'lg',
                  border: '1px solid',
                  borderColor: expandedSection === 'sync' || isSyncing ? 'blue.700' : 'gray.700',
                ...
                {!isSyncing && (
                  <span
                    className={css({
                      color: 'gray.500',
                      fontSize: 'lg',
                      transform: expandedSection === 'sync' ? 'rotate(180deg)' : 'rotate(0deg)',
            ...
            <div>
              <button
                ...
                className={css({
                  ...
                  justifyContent: 'space-between',
                  p: 3,
                  bg: expandedSection === 'capture' ? 'purple.900/30' : 'gray.800',
                  color: 'gray.200',
                  borderRadius: 'lg',
                  border: '1px solid',
                  borderColor: expandedSection === 'capture' ? 'purple.700' : 'gray.700',
                  cursor: 'pointer',
                  textAlign: 'left',
                  transition: 'all 0.15s ease',
              ...
              >
                ...
                <span
                  className={css({
                    color: 'gray.500',
                    fontSize: 'lg',
                    transform: expandedSection === 'capture' ? 'rotate(180deg)' : 'rotate(0deg)',
                    transition: 'transform 0.2s ease',
                  })}
                >
                  ▾
      ...
      {isSyncing ? (
        ...
        <>
          ...
          {(syncStatus?.excludedByDeletion ?? 0) > 0 && (
            ...
            >
              <span>🚫</span>
              <span>{syncStatus?.excludedByDeletion} excluded (previously deleted)</span>
            </div>
          )}
          ...
          >
            {hasNewOnRemote ? `Download ${syncStatus?.newOnRemote} Images` : 'Already in sync ✓'}
          </button>
        </>
      )}
    </div>
