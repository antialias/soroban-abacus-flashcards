 ...
 */
export function SharedSettingsButton({ config, onClick }: SharedSettingsButtonProps) {
  ...
  const constrainPosition = (x: number, y: number) => {
    ...
    const actionButton = document.querySelector('[data-action="download-shared-worksheet"]')
