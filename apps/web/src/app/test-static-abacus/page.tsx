  ...
  return (
    <div style={{ padding: "40px", maxWidth: "1200px", margin: "0 auto" }}>
      ...
      <p style={{ color: "#64748b", marginBottom: "30px" }}>
        ...
        directive! All abacus displays below are rendered on the server with
      ...
      >
        {numbers.map((num) => (
          ...
          >
            ...
            />
            <span
              style={{ fontSize: "20px", fontWeight: "bold", color: "#475569" }}
            >
              {num}
            </span>
          </div>
      ...
      >
        ...
        <p style={{ color: "#15803d" }}>
          If you can see the abacus displays above, then AbacusStatic is working
          correctly in React Server Components. Check the page source -
          you&apos;ll see pure HTML/SVG with no client-side hydration markers!
        </p>
      </div>
    </div>
  );
