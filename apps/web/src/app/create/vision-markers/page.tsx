    ...
    >
      ...
      >
        ...
        <div className={css({ textAlign: "center", mb: 8 })}>
          ...
          >
            Download ArUco markers for automatic calibration. Place these
            markers on the four corners of your abacus for instant camera
            calibration.
          </p>
        </div>
        ...
        >
          ...
          <p className={css({ color: "gray.600", fontSize: "sm", mb: 4 })}>
            Download a printable sheet with all 4 markers. Print at 100% scale
            on adhesive paper or regular paper with double-sided tape.
          </p>
        ...
        >
          ...
          <p className={css({ color: "gray.600", fontSize: "sm", mb: 4 })}>
            Download individual SVG files to integrate into your 3D-printed
            abacus design. These can be used for laser engraving or as inlays.
          </p>
        ...
        >
          ...
          >
            <li>
              <strong>Print at 100% scale</strong> - Do not use "Fit to Page" or
              any scaling option. The markers must be printed at their exact
              size for accurate detection.
            </li>
            <li>
              <strong>Use adhesive paper</strong> - For best results, print on
              adhesive-backed paper or label sheets. Alternatively, use
              double-sided tape.
            </li>
            <li>
              <strong>Cut with white border</strong> - Leave a small white
              border (2-3mm) around each marker. This helps with detection.
            </li>
            <li>
              <strong>Place on frame corners</strong> - Attach each marker to
              the corresponding corner of your abacus frame:
              <ul className={css({ listStyleType: "disc", pl: 5, mt: 1 })}>
                ...
                <li>
                  Bottom-Right marker (ID 2) → bottom-right corner of frame
                </li>
                <li>Bottom-Left marker (ID 3) → bottom-left corner of frame</li>
              </ul>
            </li>
            <li>
              <strong>Keep markers flat</strong> - Ensure markers are flat and
              not wrinkled for reliable detection.
            </li>
          </ol>
        </div>
