    ...
    return (
      ...
      >
        <div>
          ...
          >
            This demonstrates how placeholder pages appear during virtual
            scrolling. Pages load on-demand as they become visible in the
            viewport, showing a loading state while the SVG is being generated
            and fetched.
          </p>
        </div>
    ...
    return (
      ...
      >
        <div style={{ textAlign: "center" }}>
          ...
          <p
            style={{ marginBottom: "16px", fontSize: "12px", color: "#6b7280" }}
          >
            8.5" × 11"
          </p>
          <PagePlaceholder
      ...
      <div>
        ...
        >
          ...
          <p style={{ margin: "8px 0 0 0" }}>
            Notice the spinning hourglass emoji and "Loading page X..." text.
            The entire placeholder pulses to indicate active loading. This
            appears when pages are being fetched from the API.
          </p>
        </div>
        <PagePlaceholder
          pageNumber={7}
