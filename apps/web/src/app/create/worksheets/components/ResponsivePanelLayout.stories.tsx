  ...
  render: () => {
    return (
      <div style={{ height: "100vh", width: "100vw" }}>
        ...
        >
          <strong>🎯 Virtual Loading Demo:</strong> Scroll down in the preview
          panel to see pages load on-demand. Pages show a loading state
          (spinning hourglass) while being fetched, then display the placeholder
          once loaded.
        </div>
        <ResponsivePanelLayout
          config={mockConfig}
...
export const ManyPages: Story = {
  render: () => (
    <div style={{ height: "100vh", width: "100vw" }}>
      ...
      >
        <strong>⚡ Performance:</strong> 50 pages × 20 problems = 1,000
        problems. Virtual loading keeps it smooth!
      </div>
      <ResponsivePanelLayout
...
export const ResizablePanels: Story = {
  render: () => (
    <div style={{ height: "100vh", width: "100vw" }}>
      ...
      >
        <strong>↔️ Resizable:</strong> Drag the divider between panels to adjust
        the layout. Your preference is saved automatically!
      </div>
      <ResponsivePanelLayout
        config={mockConfig}
        sidebarContent={<MockSidebar />}
