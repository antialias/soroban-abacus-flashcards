...
export function RuleThermometer({
  ...
  const isMixedMode =
    resolvedAdditionValue !== undefined &&
    resolvedSubtractionValue !== undefined;
      ...
      >
        {RULE_OPTIONS.map((option, index) => {
          ...
          const additionDefersHere =
            isMixedMode &&
            isAutoSelected &&
            resolvedAdditionValue === option.value;
          const subtractionDefersHere =
            isMixedMode &&
            isAutoSelected &&
            resolvedSubtractionValue === option.value;
          const isAutoResolvedMixed =
            additionDefersHere || subtractionDefersHere;

          // For single operator mode
          const isAutoResolved =
            !isMixedMode && isAutoSelected && resolvedValue === option.value;

          // Determine which operator to show
          let operatorToShow: "addition" | "subtraction" | "mixed" | null =
            null;
