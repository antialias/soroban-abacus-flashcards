                          ...
                          >
                            {dropdownOptions.includes(pages)
                              ...
                              : dropdownOptions.length > 0
                                ...
                                : "•••"}
                            <span
                              className={css({ fontSize: "2xs", opacity: 0.7 })}
                            >
                              ▼
                            </span>
                      ...
                      {dropdownOptions.includes(pages) &&
                        getTooltipMessage(getValidationForPageCount(pages)) && (
                          <Tooltip.Portal>
                            ...
                            >
                              {getTooltipMessage(
                                getValidationForPageCount(pages),
                              )}
                              <Tooltip.Arrow
                                className={css({
                                  fill: isDark ? "gray.800" : "white",
            ...
            <DropdownMenu.Root>
              <DropdownMenu.Trigger asChild>
                ...
                >
                  ...
                  >
                    {problemsPerPage} problems ({cols} cols ×{" "}
                    {Math.ceil(problemsPerPage / cols)} rows)
                  </span>
                  <span
                    className={css({
                      fontSize: "xs",
                ...
                >
                  ...
                  >
                    {problemsForOrientation.map((count) => {
                      const itemCols = getDefaultColsForProblemsPerPage(
                        count,
                        orientation,
                      );
          ...
          >
            ...
            >
              ...
              <button
                ...
                onClick={() => {
                  onProblemNumbersChange?.(
                    problemNumbers === "always" ? "never" : "always",
                  );
                }}
                className={css({
                  position: "relative",
            ...
            >
              ...
              <button
                ...
                onClick={() => {
                  onCellBordersChange?.(
                    cellBorders === "always" ? "never" : "always",
                  );
                }}
                className={css({
                  position: "relative",
