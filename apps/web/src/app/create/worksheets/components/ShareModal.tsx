    ...
    const generateShare = async () => {
      ...
      try {
        ...
        console.log("[ShareModal] Creating share with config:", {
          ...
          totalProblems:
            (extractedConfig.pages || 0) *
            (extractedConfig.problemsPerPage || 0),
        });
      ...
      >
        <div className={stack({ gap: "4" })}>
          ...
          <div>
            ...
            >
              Create a shareable link to this exact worksheet configuration.
              Anyone with the link can view and generate this worksheet.
            </p>
          </div>
