          ...
          >
            <div>
              ...
              <p style={{ margin: "4px 0 0 0", color: "#6b7280" }}>
                Choose operator (Addition, Subtraction, or Mixed) and select
                mode (Manual, Smart, or Mastery).
              </p>
            </div>
            <div>
              <strong>📐 Layout Tab:</strong>
              <p style={{ margin: "4px 0 0 0", color: "#6b7280" }}>
                Configure page orientation, problems per page, number of pages,
                and column layout.
              </p>
            </div>
            <div>
              ...
              <p style={{ margin: "4px 0 0 0", color: "#6b7280" }}>
                Control when visual aids appear (ten-frames, carry boxes, place
                value colors, etc.). Set rules like "always", "never", or "when
                regrouping".
              </p>
            </div>
            <div>
              ...
              <p style={{ margin: "4px 0 0 0", color: "#6b7280" }}>
                Adjust regrouping frequency, difficulty presets, and progressive
                difficulty settings.
              </p>
            </div>
            <div
            ...
            >
              ...
              >
                Active tab is saved to sessionStorage. When you return, the same
    ...
    return (
      ...
      >
        <div style={{ flex: 1, display: "flex", flexDirection: "column" }}>
          ...
          <div
            style={{ flex: 1, border: "2px solid #3b82f6", borderTop: "none" }}
          >
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column" }}>
          ...
          <div
            style={{ flex: 1, border: "2px solid #6b7280", borderTop: "none" }}
          >
