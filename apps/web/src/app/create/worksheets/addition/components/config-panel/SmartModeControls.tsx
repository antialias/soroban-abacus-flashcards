...
export function SmartModeControls({
  ...
  const handleDifficultyChange = (
    ...
    onChange({
      ...
      difficultyProfile:
        result.difficultyProfile !== "custom"
  ...
  return (
    ...
    >
      <div className={stack({ gap: "2.5" })}>
        ...
        {(() => {
          const currentProfile = formState.difficultyProfile as
            | DifficultyLevel
            | undefined;
          ...
          const displayRules: DisplayRules = {
            ...
            borrowNotation: (formState.displayRules as any)?.borrowNotation ?? profile.displayRules.borrowNotation,
            borrowingHints: (formState.displayRules as any)?.borrowingHints ?? profile.displayRules.borrowingHints,
          };
          ...
          if (isCustom) {
            ...
            const easierPresets = distances.filter(
              (d) => d.difficulty < currentDifficultyValue,
            );
            const harderPresets = distances.filter(
              (d) => d.difficulty > currentDifficultyValue,
            );

            nearestEasier =
              easierPresets.length > 0
                ? easierPresets[0].presetName
                : distances[0].presetName;
            nearestHarder =
          ...
          const canMakeEasierSupport =
            easierResultSupport.changeDescription !==
            "Already at minimum difficulty";
          ...
          const canMakeHarderSupport =
            harderResultSupport.changeDescription !==
            "Already at maximum difficulty";
                        ...
                        >
                          {hoverPreview ? (
                            ...
                            <>
                              ...
                              <div>
                                Always: carry boxes, answer boxes, place value
                                colors, ten-frames
                              </div>
                            </>
                          )}
                  ...
                  <DropdownMenu.Portal>
                    ...
                    >
                      {DIFFICULTY_PROGRESSION.map((presetName) => {
                        const preset = DIFFICULTY_PROFILES[presetName];
                        const isSelected =
                          currentProfile === presetName && !isCustom;
                          ...
                          <button
                            ...
                            className={css({
                              ...
                              borderColor: canMakeEasier
                                ? "brand.500"
                                : "gray.300",
                              borderTopLeftRadius: canEasierAlternative
                                ? "none"
                                : "lg",
                              borderBottomLeftRadius: canEasierAlternative
                                ? "none"
                                : "lg",
                        ...
                        <div className={css({ display: "flex", flex: "1" })}>
                          ...
                          <button
                            ...
                            className={css({
                              ...
                              borderTopLeftRadius: "lg",
                              borderBottomLeftRadius: "lg",
                              borderTopRightRadius: canHarderAlternative
                                ? "none"
                                : "lg",
                              borderBottomRightRadius: canHarderAlternative
                                ? "none"
                                : "lg",
                ...
                <div className={css({ position: "relative", px: "2" })}>
                  <Slider.Root
                    ...
                    onValueChange={(value) => {
                      ...
                      const presetPoints = DIFFICULTY_PROGRESSION.map(
                        (presetName) => {
                          const preset = DIFFICULTY_PROFILES[presetName];
                      ...
                      for (let i = 0; i < presetPoints.length - 1; i++) {
                        ...
                        if (
                          ...
                          idealRegrouping =
                            start.regrouping +
                            t * (end.regrouping - start.regrouping);
                          idealScaffolding =
                            start.scaffolding +
                            t * (end.scaffolding - start.scaffolding);
                          console.log(
                      ...
                      if (targetDifficulty < presetPoints[0].difficulty) {
                        ...
                        targetDifficulty >
                        presetPoints[presetPoints.length - 1].difficulty
                      ) {
                        idealRegrouping =
                          presetPoints[presetPoints.length - 1].regrouping;
                        idealScaffolding =
                          presetPoints[presetPoints.length - 1].scaffolding;
                      }
                      ...
                      for (
                        let regIdx = 0;
                        regIdx < REGROUPING_PROGRESSION.length;
                        regIdx++
                      ) {
                        for (
                          let scaffIdx = 0;
                          ...
                          const displayRules =
                            SCAFFOLDING_PROGRESSION[scaffIdx];
                          ...
                          if (
                            closestConfig === null ||
                            distance < closestConfig.distance
                          ) {
                            closestConfig = {
                    ...
                    >
                      {(() => {
                        ...
                        const calculateValidTarget = (
                          ...
                          for (const profileName of DIFFICULTY_PROGRESSION) {
                            ...
                            if (distance <= snapThreshold) {
                              if (
                                !nearestPreset ||
                                distance < nearestPreset.distance
                              ) {
                        ...
                        const handleMouseMove = (
                          ...
                          const target = calculateValidTarget(
                            e.clientX,
                            e.clientY,
                            svg,
                          );
