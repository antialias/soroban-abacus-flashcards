...
export function SmartModeControls({ formState, onChange, isDark = false }: SmartModeControlsProps) {
  ...
  const handleDifficultyChange = (mode: DifficultyMode, direction: 'harder' | 'easier') => {
    const currentState = {
      ...
      displayRules: formState.displayRules ?? DIFFICULTY_PROFILES.earlyLearner.displayRules,
    }
                ...
                <DropdownMenu.Root>
                  <DropdownMenu.Trigger asChild>
                    ...
                    >
                            ...
                            <>
                              {hoverPreview.matchedProfile !== 'custom' ? (
                                <>
                                  ...
                                  <span className={css({ fontSize: 'xs', color: 'orange.500' })}>
                                    (hover preview)
                                  </span>
                                </>
                              ) : (
                      ...
                      <span className={css({ fontSize: 'xs', color: 'gray.400', flexShrink: 0 })}>
                        ▼
                      </span>
                    </button>
