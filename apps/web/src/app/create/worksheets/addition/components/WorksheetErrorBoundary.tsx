...
export class WorksheetErrorBoundary extends React.Component<Props, State> {
  ...
  componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
    ...
    console.error(
      "Worksheet Error Boundary caught an error:",
      error,
      errorInfo,
    );
            ...
            <div className={stack({ gap: "6" })}>
              ...
              <div className={stack({ gap: "3", textAlign: "center" })}>
                ...
                <p className={css({ fontSize: "md", color: "gray.600" })}>
                  We encountered an unexpected error while loading the worksheet
                  creator. This shouldn't happen, and we apologize for the
                  inconvenience.
                </p>
              </div>
