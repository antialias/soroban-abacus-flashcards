...
export const SKILL_DEFINITIONS: SkillDefinition[] = [
...

  {
    ...
    description:
      "Two-digit addition with carrying in ones place like 38+27, 49+15",
    operator: "addition",
    digitRange: { min: 2, max: 2 },
...

  {
    ...
    description:
      "Two-digit addition with high regrouping frequency like 88+99, 76+67",
    operator: "addition",
    digitRange: { min: 2, max: 2 },
...

  {
    ...
    description:
      "Three-digit addition with some carrying like 367+258, 484+273",
    operator: "addition",
    digitRange: { min: 3, max: 3 },
...

  {
    ...
    description:
      "Three-digit addition with high regrouping like 888+999, 767+676",
    operator: "addition",
    digitRange: { min: 3, max: 3 },
...

  {
    ...
    description:
      "Two-digit subtraction with high borrowing frequency like 91-78",
    operator: "subtraction",
    digitRange: { min: 2, max: 2 },
    regroupingConfig: { pAnyStart: 0.9, pAllStart: 0.5 },
    recommendedScaffolding: {
...

  {
    ...
    description:
      "Five-digit subtraction with varied borrowing like 58472-29563",
    operator: "subtraction",
    digitRange: { min: 5, max: 5 },
    regroupingConfig: { pAnyStart: 0.85, pAllStart: 0.5 },
    recommendedScaffolding: {
 ...
 */
export function getSkillsByOperator(
  operator: "addition" | "subtraction",
): SkillDefinition[] {
