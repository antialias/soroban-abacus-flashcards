...
export const additionConfigV1Schema = z.object({
  ...
  problemsPerPage: z
    ...
    .int()
    .min(1)
    .max(WORKSHEET_LIMITS.MAX_PROBLEMS_PER_PAGE),
...
export type AdditionConfigV3Custom = z.infer<
  typeof additionConfigV3CustomSchema
>;
...
export type AdditionConfigV4Custom = z.infer<
  typeof additionConfigV4CustomSchema
>;
export type AdditionConfigV4Manual = z.infer<
  typeof additionConfigV4ManualSchema
>;
export type AdditionConfigV4Mastery = z.infer<
  typeof additionConfigV4MasterySchema
>;
