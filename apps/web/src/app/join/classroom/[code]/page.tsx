    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            No classroom found with code <strong>{code}</strong>. Please check
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            You need to add a child to your account before enrolling them in a
            classroom.
          </p>
          <button
            type="button"
    ...
    >
      ...
      >
        {isLoading ? (
          ...
          // Success state
          <div
            data-section="enrollment-success"
          ...
          >
            ...
            >
              ...
              to join <strong>{classroom?.name}</strong>.
            </p>
            <button
              type="button"
              ...
              >
                ...
                >
                  ...
                  <div>
                    ...
                    >
                      Teacher:{" "}
                      {(classroom as { teacher?: { name?: string } }).teacher
                        ?.name ?? "Teacher"}
                    </p>
                  </div>
                </div>
