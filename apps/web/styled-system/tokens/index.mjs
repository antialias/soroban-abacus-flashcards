const tokens = {
  ...
  "colors.soroban.wood": {
    "value": "#8B4513",
    "variable": "var(--colors-soroban-wood)"
  },
  "colors.soroban.bead": {
    "value": "#2C1810",
    "variable": "var(--colors-soroban-bead)"
  },
  "colors.soroban.inactive": {
    "value": "#D3D3D3",
    "variable": "var(--colors-soroban-inactive)"
  },
  "colors.soroban.bar": {
    "value": "#654321",
    "variable": "var(--colors-soroban-bar)"
  },
  "fonts.sans": {
  ...
  "colors.colorPalette.wood": {
    "value": "var(--colors-color-palette-wood)",
    "variable": "var(--colors-color-palette-wood)"
  },
  "colors.colorPalette.bead": {
    "value": "var(--colors-color-palette-bead)",
    "variable": "var(--colors-color-palette-bead)"
  },
  "colors.colorPalette.inactive": {
    "value": "var(--colors-color-palette-inactive)",
    "variable": "var(--colors-color-palette-inactive)"
  },
  "colors.colorPalette.bar": {
    "value": "var(--colors-color-palette-bar)",
    "variable": "var(--colors-color-palette-bar)"
  }
}
